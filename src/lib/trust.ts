...
export const TRUST_TIERS: { slug: TrustTierSlug; min: number; color: string }[] = [
  ...
  { slug: 'bilby', min: 5, color: '#7A8CA3' },
  { slug: 'koala', min: 15, color: '#6B7FB8' },
  { slug: 'wombat', min: 30, color: '#9A6BB8' },
  { slug: 'wallaby', min: 60, color: '#C2703E' },
  { slug: 'kangaroo', min: 100, color: '#B8860B' },
];
